...
dhs_survey2 <- function(dhs){
  ...
  if ('natural' %in% floorcategories){
    ...
    naturalfloor <- c('earth-based', 'earth, sand', 'earth, mud', 'earth, mud, clay', 'sand', 'dirt/earth',
    ...
    finishedfloor <- c('parquet/polished wood', 'polished wood/vinyl/tiles', 'vinyl/asphalt strips/linoleum',
                       ...
                       'parquet, polished wood', 'woolen carpets/ synthetic carpet', 'vinyl, asphalt strips',
  ...
  if ('natural' %in% roofcategories){
    ...
    finishedroofs <- c('metal', 'metal, zinc', 'corrugated metal sheet, asbestos', 'corrugated iron', 'tin', 
                       ...
                       'tiles', 'ceramic tiles', 'iron and tiles', 'tiles/slate', 'mud tiles', 
...
filename_dferrors <- paste0("synth_errors_synth_DHS_aug24_", isocode, ".csv") #was oct, nov. 
